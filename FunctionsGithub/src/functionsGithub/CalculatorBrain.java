	...
	public static void main(String[] args) {
		...
		switch(opcion) {
			...
			case 4:
				...
				break;
			case 5:
				System.out.println("La raíz cuadrada del primer número es: " + raizCuadrada(num1));
				break;
			case 6:
				System.out.println("La potencia del primer número elevado al segundo número es: " + potencia(num1, num2));
				break;
			default:
